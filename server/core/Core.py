...
class Core():
    def __init__(self, product_name):
        ...
        if type(product_name) != type(""):
            return []
        try:
          jumia = JumiaEngine("https://www.jumia.com.gh/", f'{str(product_name)}', querytype="catalog/?q=").process()
          jiji = JijiEngine('https://jiji.com.gh/', f'{str(product_name)}').process()
          tonaton = TonatonEngine("https://tonaton.com/", f'{str(product_name)}').process()
